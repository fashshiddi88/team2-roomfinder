// app/Tenant_Report/components/SalesTable.tsx
'use client';
        ...
        <tbody>
          {data.map((tx, i) => (
            ...
            >
              ...
              <td className="p-3">{format(new Date(tx.checkIn), 'yyyy-MM-dd')}</td>
              <td className="p-3">{format(new Date(tx.checkOut), 'yyyy-MM-dd')}</td>
